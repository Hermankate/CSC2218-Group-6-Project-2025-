...
#             add_note(title_input.value, content_input.value)  # Fixed argument issue
#             title_input.value = ""
#             content_input.value = ""
#             tag_input.value = ""
#             load_notes()
...
#         page.views.clear()
#         if route.route == "/":
#             page.views.append(todo_app(page))
#         elif route.route == "/notes":
#             page.views.append(notes_app(page))
#         page.update()

#     page.on_route_change = route_change
#     page.go("/")  

# ft.app(target=main, view=ft.AppView.FLET_APP)  # Corrected to match Flet's mobile view
import flet as ft
from backend.db import init_db, add_note, get_notes, update_note, delete_note
from frontend.ui import note_card
